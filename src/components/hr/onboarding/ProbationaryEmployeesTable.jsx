...
const ProbationaryEmployeesTable = ({ onAction, onDelete, onViewDetails }) => {
  ...
  const [filterStatus, setFilterStatus] = useState("true"); // Default to Probationary only
  ...
  const clearAllFilters = () => {
    ...
    setFilterMobile("");
    setFilterLocation("");
    // Don't clear filterStatus and filterEmploymentStatus as they should remain fixed
  };
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">
                Probationary Employees (On Progress)
              </h2>
              {hasActiveFilters && (
                <button
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm">
                        No employees on probation with On_Progress status
                      </p>
                    </div>
                  </td>
                </tr>
                  ...
                  return (
                    <tr key={emp.employee_id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="px-3 py-1 text-xs font-semibold rounded-full border bg-blue-100 text-blue-700 border-blue-300">
                          {currentStatus || "N/A"}
                        </span>
                      </td>
...
export default ProbationaryEmployeesTable;