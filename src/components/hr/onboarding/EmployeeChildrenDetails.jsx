...
//       const payload = {
//         employee_id: employeeId,
//         child_number: Number(editingChild.child_number),
//         child_name: editingChild.child_name,
//         child_dob: editingChild.child_dob || null,
//         child_age: Number(editingChild.child_age),
//         child_gender: editingChild.child_gender,
//       };
...
//         return true;
//       } else {
//         // alert(response.message || 'Failed to save child details');
//         toast.error(response.message || 'Failed to save child details');
//         return false;
//       }
//     } catch (error) {
...
//   const handleDeleteChild = async () => {
//     if (!editingChild.child_id) {
//       // alert('Cannot delete unsaved child');
//       toast.error('Cannot delete unsaved child');
//       return;
//     }
//     if (!window.confirm('Are you sure you want to delete this child?')) {
